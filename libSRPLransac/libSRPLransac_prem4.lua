-- premake4 script file to automate building of libSRPLransac
--
...
-- $Date$:
-- Set package name.
project "libSRPLransac"
	-- if you want a different name for your target than the projects's name.
	outName						= "libSRPLransac"
	uuid						"C8C28BD8-B75B-4151-875F-B049DCB25523"
...
-- OPTIONS ---------------------------------------------------------------------
	...
	newoption
	{
		trigger = "libSRPLransac-static",
		description = "Build libSRPLsegm as static lib rather than dll"
	}

	-- -- libSRPLavg dll
	if not _OPTIONS["libSRPLransac-static"] then
		kind 					"SharedLib"
	else
		kind 					"StaticLib"
	end
